...
int RandomInt(int lower,int upper)
{
	...
	int select;
   select=(int)floor((RandomUniform() * ((upper - lower) + 1))) + lower;
...

{
    ...
    srandom((unsigned long)seedValue);
    ...
    RandomInitialise(seedValue,seedValue-1);
...
{
    RandomInitialise(seedValue%31328,seedValue%30081);
}
...

{
	...
	return (int)(RandomInt(0,16777216));
